...
class InstructionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create instruction" do
    assert_difference('Instruction.count') do
      post instructions_url, params: { instruction: { description: @instruction.description, link: @instruction.link, name: @instruction.name, user_id: @instruction.user_id } }
    end
  ...
  test "should update instruction" do
    patch instruction_url(@instruction), params: { instruction: { description: @instruction.description, link: @instruction.link, name: @instruction.name, user_id: @instruction.user_id } }
